                      ...
                      <p class="text-gray-900 text-3xl md:text-xl font-semibold leading-loose">あなたにぴったりな<br>セレンディピティが見つかりました！</p>
                        <div>
                            <form method="post" action="{{ url('/guide') }}" id="form">
                                @csrf
                                <input type="submit" value="しおりを確認する" class="mx-auto mt-10 sm:w-fit w-full px-9 py-3 bg-yellow-600 hover:bg-yellow-700 ease-in-out transition-all duration-700 rounded-xl shadow justify-center items-center flex px-3.5 text-center text-white text-lg font-semibold leading-8 cursor-pointer" />
                            </form>
                        </div>
                    </div>
              </div>
