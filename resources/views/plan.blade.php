                      ...
                      <div class="w-full">
                          <div class="w-full justify-start items-center gap-6 flex md:flex-row flex-col">
                              <label class="w-full p-6 rounded-2xl border border-gray-200 hover:border-orange-600 hover:bg-orange-50 transition-all duration-700 ease-in-out flex-col justify-start items-center gap-3 inline-flex cursor-pointer has-[:checked]:ring-orange-500 has-[:checked]:bg-orange-50 has-[:checked]:border-orange-500 has-[:checked]:ring-orange-500"">
                                ...
                                <input type="radio" name="who" value="夫婦" class="box-content h-1.5 w-1.5 appearance-none rounded-full border-[5px] ring-1 ring-orange-950/10 checked:border-orange-500 checked:ring-orange-500" required>
                              </label>
                    ...
                    <div class="w-full">
                        <div class="w-full justify-start items-center gap-6 flex md:flex-row flex-col">
                            <label class="w-full p-6 rounded-2xl border border-gray-200 hover:border-orange-600 hover:bg-orange-50 transition-all duration-700 ease-in-out flex-col justify-start items-center gap-3 inline-flex cursor-pointer has-[:checked]:ring-orange-500 has-[:checked]:bg-orange-50 has-[:checked]:border-orange-500 has-[:checked]:ring-orange-500"">
                              ...
                              <input type="radio" name="theme" value="" class="box-content h-1.5 w-1.5 appearance-none rounded-full border-[5px] ring-1 ring-orange-950/10 checked:border-orange-500 checked:ring-orange-500" required>
                            </label>
