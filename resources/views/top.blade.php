            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <a href="javascript:;" class="max-w-[384px] mx-auto">
                    ...
                    <div class="mt-5 flex items-center justify-between">
                        <div class="">
                            <h6 class="font-medium text-xl leading-8 text-black mb-2">梅</h6>
...
<!-- こっから -->
                ...
                <a href="javascript:;" class="max-w-[384px] mx-auto">
                    ...
                    <div class="mt-5 flex items-center justify-between">
                        <div class="">
                            <h6 class="font-medium text-xl leading-8 text-black mb-2">松</h6>
                ...
                <a href="javascript:;" class="max-w-[384px] mx-auto">
                    ...
                    <div class="mt-5 flex items-center justify-between">
                        <div class="">
                            <h6 class="font-medium text-xl leading-8 text-black mb-2">竹</h6>
