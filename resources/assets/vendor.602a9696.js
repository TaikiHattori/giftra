...
function $(e) {
    ...
    m > 0 ? (S && T && i.allowThresholdMove && i.currentTranslate > (r.centeredSlides ? s.minTranslate() - s.slidesSizesGrid[s.activeIndex + 1] : s.minTranslate()) && s.loopFix({
        direction: "prev",
        setTranslate: !0,
        activeSlideIndex: 0
    }),
    i.currentTranslate > s.minTranslate() && (b = !1,
    r.resistance && (i.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + i.startTranslate + m) ** x))) : m < 0 && (S && T && i.allowThresholdMove && i.currentTranslate < (r.centeredSlides ? s.maxTranslate() + s.slidesSizesGrid[s.slidesSizesGrid.length - 1] : s.maxTranslate()) && s.loopFix({
        direction: "next",
        setTranslate: !0,
...
function j(e) {
    ...
    if (p > n.longSwipesMs) {
        ...
        "next" === t.swipeDirection && (S >= n.longSwipesRatio ? t.slideTo(n.rewind && t.isEnd ? g : h + T) : t.slideTo(h)),
        "prev" === t.swipeDirection && (S > 1 - n.longSwipesRatio ? t.slideTo(h + T) : null !== w && S < 0 && Math.abs(S) > n.longSwipesRatio ? t.slideTo(w) : t.slideTo(h))
    } else {
        if (!n.shortSwipes)
            return void t.slideTo(t.activeIndex);
        t.navigation && (r.target === t.navigation.nextEl || r.target === t.navigation.prevEl) ? r.target === t.navigation.nextEl ? t.slideTo(h + T) : t.slideTo(h) : ("next" === t.swipeDirection && t.slideTo(null !== g ? g : h + T),
...
const Q = {
        ...
        updateSlides: function() {
            ...
            for (let b = 0; b < p; b += 1) {
                ...
                !c[b] || "none" !== P(i, "display")) {
                    ...
                    f.push(C),
                    s.centeredSlides ? (T = T + C / 2 + x / 2 + S,
                    0 === x && 0 !== b && (T = T - n / 2 - S),
                    0 === b && (T = T - n / 2 - S),
                    Math.abs(T) < .001 && (T = 0),
            ...
            s.centeredSlides && s.cssMode && !s.centeredSlidesBounds) {
                ...
                b(i, "--swiper-centered-offset-after", e.size / 2 - f[f.length - 1] / 2 + "px");
    ...
    loop: {
        ...
        loopFix: function(e) {
            ...
            c.recalcSlides(),
            "auto" === m.slidesPerView ? c.updateSlides() : T && (b.length > 0 && P || x.length > 0 && M) && c.slides.forEach(((e,t)=>{
